...
def game_loop(args):
    ...
    try:
        ...
        data_recorder=data_query.dataQ(hud)      #creating an object of the data query class
        ...
        while True:
            ...
            # -------------extracng actor list and querying data----------------------------
            actor_list=wrld.get_actors()
            data_recorder.data_input(actor_list)
